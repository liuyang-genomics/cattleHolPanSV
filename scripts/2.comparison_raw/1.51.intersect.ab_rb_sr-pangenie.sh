...
scp -r ${CLUSTER_HOST}:${PROJECT_ROOT}/stat_pan/4.truvari_sv/*tsv .
...
C:\Users\${USER}\OneDrive - University of Maryland\Data\2024-02-07.cattleLR-SR-GWAS\2.analyses\1.6.sv_truvari
 ...
 cat truvari.pangenie.tsv | awk 'BEGIN {OFS="\t"} {split($2,a,"."); if(a[1]==a[2]){print}}' | 

scp -r ${CLUSTER_HOST}:${PROJECT_ROOT}/stat_pan/3.intersect.ab_rb_sr/9.sv.share_pangenie .
scp -r ${CLUSTER_HOST}:${PROJECT_ROOT}/stat_pan/4.truvari_sv/truvari.pangenie.tsv .


C:\Users\${USER}\OneDrive - University of Maryland\Data\2024-02-07.cattleLR-SR-GWAS\2.analyses\v_1.7.panWGS
